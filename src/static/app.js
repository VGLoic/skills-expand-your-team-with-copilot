document.addEventListener("DOMContentLoaded", () => {
  ...
  function displayFilteredActivities() {
    ...
    Object.entries(allActivities).forEach(([name, details]) => {
      ...
      if (currentDifficulty === "all") {
        // Show all activities regardless of difficulty
        // No filtering needed
      } else if (currentDifficulty === "") {
        // If "No Level Specified" is selected, only show activities without a difficulty field
  ...
  function renderActivityCard(name, details) {
    ...
    const difficultyTagHtml = details.difficulty ? `
      <span class="difficulty-tag ${details.difficulty.toLowerCase()}">
        ${details.difficulty}
      </span>
    ` : '';
